...
class HandTracker:
    def __init__(self):
        ...
        self.hands = self.mp_hands.Hands(
            ...
            max_num_hands=2,
            model_complexity=0,  # lite model: faster inference, plenty accurate for pinch/palm gestures
            min_detection_confidence=0.5,
            min_tracking_confidence=0.5,
        )
        self.mp_draw = mp.solutions.drawing_utils  # type: ignore[attr-defined]
        self.results = None  # populated after first find_hands() call; guard before use
